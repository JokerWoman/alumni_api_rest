...
exports.getAllSkillsAvailableForAlumni = async function (req, res)  {

    let data = await skillModel.getAllSkillsAvailableForAlumni(req.params.numeroEstudante);
    ...
    if (data.kind === "ok") {
        ...
        res.status(500).json({ message: "Erro a selecionar todos os skills disponiveis" })
    }
    else {
