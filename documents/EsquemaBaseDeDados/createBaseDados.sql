...
-- Schema sql4405171
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sql4405171` ;
USE `sql4405171` ;
...
-- -----------------------------------------------------
-- Table `sql4405171`.`Nacionalidade`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sql4405171`.`Nacionalidade` ;

CREATE TABLE IF NOT EXISTS `sql4405171`.`Nacionalidade` (
...
CREATE TABLE IF NOT EXISTS `sql4405171`.`Alumni` (
  ...
  `curriculumPDFLink` VARCHAR(200) NULL,
  ...
  INDEX `fk_Alumni_Nacionalidade1_idx` (`id_nacionalidade` ASC) ,
  INDEX `fk_Alumni_CodigoPostal1_idx` (`id_codigoPostal` ASC) ,
  ...
  CONSTRAINT `fk_Alumni_Genero1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Alumni_Nacionalidade1`
    FOREIGN KEY (`id_nacionalidade`)
    REFERENCES `sql4405171`.`Nacionalidade` (`id_nacionalidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Alumni_CodigoPostal1`
...
-- -----------------------------------------------------
-- Table `sql4405171`.`Curso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sql4405171`.`Curso` ;

CREATE TABLE IF NOT EXISTS `sql4405171`.`Curso` (
...
-- -----------------------------------------------------
-- Table `sql4405171`.`Historico_Curso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sql4405171`.`Historico_Curso` ;

CREATE TABLE IF NOT EXISTS `sql4405171`.`Historico_Curso` (
  `id_nroEstudante` INT(45) NOT NULL,
  `id_curso` INT NOT NULL,
  `anoFim` VARCHAR(45) NULL,
  CONSTRAINT `fk_Historico_Curso_Curso1`
    FOREIGN KEY (`id_curso`)
    REFERENCES `sql4405171`.`Curso` (`id_curso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Historico_Curso_Alumni1`
...
CREATE TABLE IF NOT EXISTS `sql4405171`.`Professor` (
  `id_nroProfessor` INT(45) NOT NULL,
  `password` VARCHAR(45) NULL,
  ...
  INDEX `fk_Professor_CodigoPostal1_idx` (`id_codigoPostal` ASC) ,
  CONSTRAINT `fk_Professor_CodigoPostal1`
    FOREIGN KEY (`id_codigoPostal`)
    REFERENCES `sql4405171`.`CodigoPostal` (`id_codigoPostal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `sql4405171`.`Bolsa_Emprego` (
  ...
  `data_publicação` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `sql4405171`.`Historico_Eventos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sql4405171`.`Historico_Eventos` ;

CREATE TABLE IF NOT EXISTS `sql4405171`.`Historico_Eventos` (
  `data_evento` VARCHAR(45) NULL,
  `id_evento` INT(45) NOT NULL,
  `id_nroEstudante` INT(45) NOT NULL,
  INDEX `fk_Historico_Eventos_Evento1_idx` (`id_evento` ASC) ,
  INDEX `fk_Historico_Eventos_Alumni1_idx` (`id_nroEstudante` ASC) ,
  CONSTRAINT `fk_Historico_Eventos_Evento1`
    FOREIGN KEY (`id_evento`)
    REFERENCES `sql4405171`.`Evento` (`id_evento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Historico_Eventos_Alumni1`
    FOREIGN KEY (`id_nroEstudante`)
    REFERENCES `sql4405171`.`Alumni` (`id_nroEstudante`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
